...
<body style="background-color:#A6A6A6;">
    ...
    <div style="margin: 15% 25% 25% 25%;">
        <form action="../controller/taddcourseController.php" method="POST">
            ...
            <div class="container">
                <div class="col-xs-4">
                    ...
                    <input type="text" name="coursename" class="form-control" placeholder="Enter Teacher" required>
                </div>
            </div>
            <br>
            <div class="container">
                <div class="col-xs-4">
                    <label>Teacher</label>
                    <input type="text" name="teacher" class="form-control" placeholder="Enter Teacher" required>
                </div>
            </div>
            <br>
            <div class="container">
