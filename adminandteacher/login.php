...
include_once 'googlelogin/gpConfig.php';
include_once 'googlelogin/User.php';
...
<body style="background-color:#A6A6A6;">
    ...
    <div style="margin: 15% 25% 25% 25%;">
        ...
        <div style="background-color:#282D3D; color:#FFFFFF; padding:1rem; border-radius:20px;">
            ...
            <!-- <input type="button" onclick="window.location = '<?php echo $loginURL ?>';" value="Google" class="btn btn-danger">  
            <br><span class="error"><?php echo  $nameEr;?></span> -->
            <a href="<?php echo filter_var($authUrl, FILTER_SANITIZE_URL)?>" id="submit" class="btn btn-danger" style="color:#FFFFFF; margin-left:50% 10%;">Google Login</a>
