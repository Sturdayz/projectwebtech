...
<body style="background-color:#A6A6A6;">
    ...
    <div style="margin: 15% 25% 25% 25%;">
        <form action="../controller/changepassController.php" method="POST">
            ...
            <div class="container">
                <div class="col-xs-4">
                    ...
                    <input type="text" name="confirmpass" class="form-control" placeholder="Confirm New Password" required>
                </div>
            </div>
            <br>
            <button  type="submit" id="changepass" class="btn btn-dark" style="color:#FFFFFF; margin-left: 2%;" >Change Password</button>
            </div>
        </form>
    </div>
</body>
