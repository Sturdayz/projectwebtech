...
if(isset($_POST['search'])){
    ...
    $sql = 'SELECT * FROM test_subject WHERE `student_id`=:studentid';
...
<body style="background-color:#A6A6A6;">
    ...
    <div style="margin: 15% 25% 25% 25%;">
        <form action="seescore.php" method="POST">
                ...
                <tr style="color:#FFFFFF;">
                    ...
                    <?php 
                        if(isset($_POST['search'])){
                            ...
                            <th style="color:#FFFFFF;"><?php echo $row['course_id']; ?></th>
                            ...
                            <!-- <th style="color:#FFFFFF;"><a href="editscore.php?student_id=<?php echo $row["student_id"]?>">Edit</a></th> -->
                    </tbody>
                    <?php }} ?>
                </table>
            </div>
