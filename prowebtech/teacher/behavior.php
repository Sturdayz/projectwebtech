...
<body style="background-color:#A6A6A6;">
    ...
    <div style="margin: 15% 10% 25% 10%; ">
        <form action="behavior.php" method="POST">
            ...
            <br>
            <button  type="submit" id="submit" name="search" class="btn btn-dark" style="color:#FFFFFF; margin-left: 0.3%;" >Search</button>
            <br>
            <br>
        </form>
            ...
            <tr style="color:#FFFFFF;">
                ...
                <?php 
                    if(isset($_POST['search'])){
                        ...
                        <th style="color:#FFFFFF;"><?php echo $row['course_name']; ?></th>
                        <th style="color:#FFFFFF;"><?php echo $row['teacher']; ?></th>
                        <th style="color:#FFFFFF;"><?php echo $row['student_id']; ?></th>
                        <th style="color:#FFFFFF;"><?php echo $row['student_name']; ?></th>
                        <th style="color:#FFFFFF;"><?php echo $row['student_behavior_good']; ?></th>
                        <th style="color:#FFFFFF;"><?php echo $row['student_behavior_bad']; ?></th>
                        <th style="color:#FFFFFF;"><?php echo $row['student_behavior_rate']; ?></th>
                        <th style="color:#FFFFFF;"><a href="editbehavior.php?behavior_id=<?php echo $row["id"]?>">Edit</a></th>
                </tbody>
                <?php }} ?>
            </table>
    </div>
